...
public class AdminController {
    ...
    @GetMapping("/inicio")
    public String mostrarPanelAdmin(@AuthenticationPrincipal UserDetails userDetails, Model model) {
    ...
    public ResponseEntity<Map<String, String>> registrarAdmin(@ModelAttribute Usuario nuevoAdmin,
        ...
        Usuario adminPrincipal = getUsuarioAutenticado(userDetails);
        ...
        try {
            if (usuarioRepository.findByEmail(nuevoAdmin.getEmail()).isPresent()) {
    ...
    public ResponseEntity<Map<String, String>> cambiarEstado(@RequestParam String reporteId,
                                                              ...
                                                              @AuthenticationPrincipal UserDetails userDetails) {
        Map<String, String> response = new HashMap<>();
        Usuario admin = getUsuarioAutenticado(userDetails);
