...
import com.reportes.urbanos.reportes_api.model.*;
...
public class UsuarioController {
    ...
    @GetMapping("/inicio")
    public String inicioCiudadano(@AuthenticationPrincipal UserDetails userDetails, Model model) {
    ...
    public String fragmentoListaReportes(@AuthenticationPrincipal UserDetails userDetails, Model model) {
        Usuario usuario = getUsuarioAutenticado(userDetails);
    ...
    public Object fragmentoEditarReporte(@PathVariable String id,
